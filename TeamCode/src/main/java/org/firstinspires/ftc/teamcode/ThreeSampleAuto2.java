...
//                        .waitSeconds(.01)
                        .stopAndAdd(new RotateUp(rotateArm,200,3))
                        .stopAndAdd(new ExtendOut(extendArm1, extendArm2, rotateArm, Wheel1, Wheel2, 10,1,-1,1,1))
                        .stopAndAdd(new ExtendIn(extendArm1, extendArm2, rotateArm, Wheel1, Wheel2, -10,-1,1,-1,1))
                        .stopAndAdd(new RotateDown(rotateArm,-150,2))
//                        .waitSeconds(1)
